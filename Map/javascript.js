...
function GetMap()
{
    ...
    var veLayerSpec = new VEShapeSourceSpecification(VEDataType.GeoRSS, " Map/ZoosGeoRSS.xml", vezoosLayer);
...
function onFeedLoad()
{
    ...
    for(var i=0; i < numShapes; ++i)
    {
        ...
        s.SetCustomIcon("/Map/smallK.gif");
    }
...
/**
 * Created by Ajay Bakari on 19/04/2017.
 */
